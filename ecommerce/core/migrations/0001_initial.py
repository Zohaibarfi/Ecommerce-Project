...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, default='1', max_digits=99999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='1', max_digits=99999)),
                ('total', models.DecimalField(decimal_places=2, default='1', max_digits=99999)),
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.cartorder')),
            ],
            options={
                'verbose_name_plural': 'Cart Orde Items',
            },
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='1', max_digits=9999)),
                ('specificatios', models.TextField(blank=True, null=True)),
                ...
                ('categroy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345', length=110, max_length=20, prefix='ven', unique=True)),
                ('title', models.CharField(default='Product', max_length=100)),
